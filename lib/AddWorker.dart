  ...
  createWorker(){
   ...
   database.child(uid).child(newkey).set({
     ...
     for(var i=0; i<=selectedServices.length-1;i++){
       ...
       dataBase.child(newkey).child('Services').push().set({
 ...
 DisplayServices(){
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text('Add Workers',style:TextStyle(fontFamily: "Righteous",fontSize: 20,fontWeight: FontWeight.w100,color:Colors.white,)),
