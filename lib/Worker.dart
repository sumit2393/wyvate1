...
final dbRef = FirebaseDatabase.instance.reference().child("Workers").child(uid);
...
List<dynamic> workerID =[];
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            Container(
                              ...
                              child:Text('$name', style:TextStyle(fontSize: 18,fontFamily: "Righteous", fontWeight: FontWeight.w100),)
                            ),
                             Container(
                               margin: EdgeInsets.only(top:5,),
                              child:Text('${contact}', style:TextStyle(fontSize: 14,fontFamily: "Righteous", fontWeight: FontWeight.w100),)
                            ),
                                  ...
                                  Container(
                                    ...
                                    child:IconButton(
                                      ...
                                      onPressed: (){
                                        ...
                                        Navigator.pushReplacementNamed(context, '/EditWorker');
                                      },
                                    ),
                                  ),
                                  SizedBox(
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
      appBar:AppBar(
        title: Text('Staff Members',style: TextStyle(fontSize:18, fontFamily: "Righteous",fontWeight: FontWeight.bold)),
